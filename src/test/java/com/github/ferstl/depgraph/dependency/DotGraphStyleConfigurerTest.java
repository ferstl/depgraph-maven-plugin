...
public class DotGraphStyleConfigurerTest {

  private DotGraphStyleConfigurer graphStyleConfigurer;
  ...
  @Before
  public void before() {
    this.graphStyleConfigurer = new DotGraphStyleConfigurer(new StyleConfiguration());
  ...
  public void showGroupIds() {
    ...
    assertThat(this.formatter.nodes, Matchers.<Node>containsInAnyOrder(
        new Node<>(this.fromId, "[label=<group1>]", this.from),
        new Node<>(this.toId, "[label=<group2>]", this.to)));
  }
  ...
  public void showArtifactIds() {
    ...
    // assert
    assertThat(this.formatter.nodes, Matchers.<Node>containsInAnyOrder(
        new Node<>(this.fromId, "[label=<artifact1>]", this.from),
        new Node<>(VERSIONLESS_ID.render(this.to), "[label=<artifact2>]", this.to)));
  ...
  public void showVersionsOnNodes() {
    ...
    // assert
    assertThat(this.formatter.nodes, Matchers.<Node>containsInAnyOrder(
        new Node<>(this.fromId, "[label=<version1>]", this.from),
        new Node<>(this.toId, "[label=<version2>]", this.to)));
  ...
  public void showVersionsOnNodesWithConflict() {
    ...
    assertThat(this.formatter.nodes, Matchers.<Node>containsInAnyOrder(
        new Node<>(this.fromId, "[label=<version1>]", this.from),
        new Node<>(this.toId, "[label=<version2-alpha>]", this.to)));
  ...
  public void showVersionsOnEdgesWithoutConflict() {
    ...
    // assert
    assertThat(this.formatter.nodes, Matchers.<Node>containsInAnyOrder(
        new Node<>(this.fromId, "[label=\"\"]", this.from),
        new Node<>(this.toId, "[label=\"\"]", this.to)));
  ...
  public void showVersionsOnEdgesWithConflict() {
    ...
    assertThat(this.formatter.nodes, Matchers.<Node>containsInAnyOrder(
        new Node<>(this.fromId, "[label=\"\"]", this.from),
        new Node<>(this.toId, "[label=\"\"]", this.toWithConflict)));

    assertThat(this.formatter.edges, Matchers.containsInAnyOrder(new Edge(this.fromId, this.toId, "[label=\"version2\"]")));
  }
  ...
  public void showAll() {
    ...
    // assert
    assertThat(this.formatter.nodes, Matchers.<Node>containsInAnyOrder(
        new Node<>(this.fromId, "[label=<group1<br/>artifact1<br/>version1>]", this.from),
        new Node<>(this.toId, "[label=<group2<br/>artifact2<br/>version2-alpha>]", this.to)));
