...
public class JsonDependencyNodeNameRendererTest extends AbstractDependencyNodeNameRendererTest {
  ...
  protected String renderOptionalResult() {
    return "{\"optional\":true,\"scopes\":[\"compile\"]}";
  }
  ...
  protected String renderGroupIdArtifactIdVersionOptionalResult() {
    return "{\"groupId\":\"groupId\",\"artifactId\":\"artifactId\",\"version\":\"version\",\"optional\":true,\"scopes\":[\"compile\"]}";
  }
  ...
  protected String renderGroupIdArtifactIdOptionalResult() {
    return "{\"groupId\":\"groupId\",\"artifactId\":\"artifactId\",\"optional\":true,\"scopes\":[\"compile\"]}";
  }
  ...
  protected String renderGroupIdVersionOptionalResult() {
    return "{\"groupId\":\"groupId\",\"version\":\"version\",\"optional\":true,\"scopes\":[\"compile\"]}";
  }
  ...
  protected String renderArtifactIdVersionOptionalResult() {
    return "{\"artifactId\":\"artifactId\",\"version\":\"version\",\"optional\":true,\"scopes\":[\"compile\"]}";
  }
