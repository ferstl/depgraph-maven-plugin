...
final class GraphBuilderAdapter {
  ...
  public void buildDependencyGraph(MavenProject project, ArtifactFilter globalFilter, DotBuilder<DependencyNodeAdapter> dotBuilder) {
  ...
  private void createGraph(MavenProject project, ArtifactFilter globalFilter, DotBuilder<DependencyNodeAdapter> dotBuilder) throws DependencyGraphException {
  ...
  private void createTree(MavenProject project, ArtifactFilter globalFilter, DotBuilder<DependencyNodeAdapter> dotBuilder) throws DependencyGraphException {
